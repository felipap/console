...
public class SerialDriver {
	...
	private final String TAG = SerialDriver.class.getSimpleName();

	private final UsbDevice mDevice;
	private final ArduinoUsbPort mPort;

	public SerialDriver(UsbDevice device) {
		mDevice = device;
		mPort = new ArduinoUsbPort(device, 0);
	}
...
//	@Override
//	public List<SerialDriver> getPorts() {
//		return Collections.singletonList(mPort);
//	}

	public ArduinoUsbPort getPort() {
		return mPort;
	}

	// Add static method for printer detection
